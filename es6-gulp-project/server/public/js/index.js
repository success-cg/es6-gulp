...
/***/ (function(module, exports, __webpack_require__) {
...

	{
	   ...
	   * 数组API：Array.from
	   */
	  var p = document.getElementsByTagName('p'); //伪数组
...

	{
	  ...
	  try {
	    for (var _iterator = ['a', '1', 'ss'].keys()[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	  ...
	  try {
	    for (var _iterator2 = ['a', '1', 'ss'].values()[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
	  ...
	  try {
	    for (var _iterator3 = ['a', '1', 'ss'].entries()[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
	      var _step3$value = _slicedToArray(_step3.value, 2),
	          _index = _step3$value[0],
	          _value = _step3$value[1];

	      console.log('[index, value]', [_index, _value]); // [0,'a'] [1,'1'] [2,'ss']
